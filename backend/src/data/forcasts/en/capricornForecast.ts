...
- Saturn’s influence encourages serious commitments
- Avoid emotional rigidity in relationships
- Communication is key to maintaining harmony

Health and Personal Balance 🧘:
- Increased physical energy due to Mars’ influence
- Risk of burnout if overworked—prioritize rest
...
- Saturn’s impact: Encourages responsibility in relationships and finances
- Key Periods:
...
`;
export default capricornForecastEn;
